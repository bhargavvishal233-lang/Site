...
echo "aradhyakaustubh1210@gmail.com" | npx vercel env add ADMIN_NOTIFICATION_EMAIL production,preview,development
echo "Spectrum <aradhyakaustubh1210@gmail.com>" | npx vercel env add EMAIL_FROM production,preview,development
echo "aradhyakaustubh1210@gmail.com" | npx vercel env add GMAIL_USER production,preview,development
